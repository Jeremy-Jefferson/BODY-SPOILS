  ...
  return (
    <div className="client-details-form">
      ...
      <p className="client-details-subtitle">
        Please share your contact information so we can review your appointment
        request and follow up with confirmation details.
      </p>
      ...
      <form onSubmit={handleSubmit} className="client-form" noValidate>
        ...
        <TextArea
          ...
          onChange={handleChange}
          placeholder="Any preferences, focus areas, or health considerations we should know about?"
          rows={3}
        />
